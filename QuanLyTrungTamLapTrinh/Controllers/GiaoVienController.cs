...
namespace QuanLyTrungTamLapTrinh.Controllers
{
    public class GiaoVienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,HoTen,SoDT,SoCCCD,GioiTinh,Email,DiaChi,ChuyenMon,Luong,GhiChu,TinhTrang,HinhAnh")] GiaoVien giaoVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,HoTen,SoDT,SoCCCD,GioiTinh,Email,DiaChi,ChuyenMon,Luong,GhiChu,TinhTrang,HinhAnh")] GiaoVien giaoVien)
        {
            if (id != giaoVien.Id)
            {
                return NotFound();
