...
require.cache[require.resolve("~/AdminTE/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("~/AdminTE/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("~/AdminTE/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["~/AdminTE/lib/codemirror"], mod); }
